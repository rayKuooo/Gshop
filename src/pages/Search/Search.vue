  ...
  <section class="search">
    ...
    <section class="list" v-if="!noSearchShops">
      <ul class="list_container">
        ...
        <router-link :to="{path:'/shop', query:{id:searchshop.id}}" tag="li" class="list_li"
                     v-for="(searchshop, index) in searchShops" :key="index">
          ...
          <section class="item_right">
            <div class="item_right_text">
              ...
              <p>月售 {{searchshop.rencent_order_num}} 单</p>
