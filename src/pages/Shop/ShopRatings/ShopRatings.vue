  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="rating-wrapper">
        <ul>
          <li v-for="(rating, index) in filterRatings" class="rating-item" :key="index">
            <div class="avatar">
...
<script>
  ...
  export default {
    data() {
      return {
        onlyShowText: true,  //只显示有评论的
        selectType: 2,    //显示全部。0为满意。1为不满意
      }
    },
    mounted() {
    ...
    computed: {
      ...
      filterRatings(){
        ...
        return ratings.filter(rating => {
          ...
          /*
            条件1：
                selectType: 0/1/2  用户选择要查看的
                rateType: 0/1   评论本身满意/不满意
    ...
    methods: {
      setSelectType(slectType){
        this.selectType = slectType
      }
    },
    components: {
      Star
