<template>
  <section class="loginContainer">
          ...
          <div :class="{on : !loginWay}">
            <section>
              ...
              <section class="login_message">
                ...
                <img class="get_verification" @click="getCaptcha"
    ...
    <AlterTip v-show="alterShow" :alertText="alertText" @closeTip="closeTip"></AlterTip>
  </section>
</template>


<script>
  import AlterTip from "../../components/AlertTip/AlterTip";
      ...
      methods: {
          ...
          async login () {
              ...
              if (this.loginWay) {
                  ...
                  if (!rightPhone){
                      //手机号不正确
                      this.showAlter('手机号不正确')
                      return
                  }else if (!/^\d{6}$/.test(code)){
                      //短信验证码不正确
                      this.showAlter('短信验证码不正确')
                      return
                  }
